const inBoundsActionsHandler = require("./helpers/inBoundsActionsHandler"),
  outOfBoundsActionsHandler = require("./helpers/outOfBoundsActionsHandler"),
  loadEncodedParamsArray = require("./helpers/loadEncodedParamsArray"),
  loadDecodedParamsArray = require("./helpers/loadDecodedParamsArray"),
  updateStateXY = require("./helpers/updateStateXY"),
  boundaryCheck = require("./helpers/boundaryCheck");

function penMovement(
  bytecodeArr,
  currentByte,
  canvasPositiveMax,
  canvasNegativeMax,
